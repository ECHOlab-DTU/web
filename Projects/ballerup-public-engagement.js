...
const noteData = {
  ...
  lessons: "<p>The event lasted one evening, guiding participants through the project and the exhibition piece. In the future, the map as well as additional exhibition pieces will be presented in a longer term exhibition at the Danish Technical Museum in Helsingør. Information regarding the project and exhibition can be found on the Grounding AI website and the museum’s website.</p>",
  collaborators: [
